    ...
    <div class="overviewBox">
      <ul>
        <li>
          ...
          <p class="tip">
            同比增长<span v-if="overviewData.turnoverGrowth">
              <span class="red" :class="overviewData.turnoverGrowth > 0 ? '' : 'green'">{{
        ...
        <li>
          ...
          <p class="tip">
            同比增长<span v-if="overviewData.validOrderCountGrowth">
              <span class="red" :class="overviewData.validOrderCountGrowth > 0 ? '' : 'green'">{{
        ...
        <li>
          ...
          <p class="tip">
            同比增长<span v-if="overviewData.orderCompletionRateGrowth">
              <span class="red" :class="overviewData.orderCompletionRateGrowth > 0 ? '' : 'green'
                ">{{
        ...
        <li>
          ...
          <p class="tip">
            同比增长<span v-if="overviewData.unitPriceGrowth">
              <span class="red" :class="overviewData.unitPriceGrowth > 0 ? '' : 'green'">{{
        ...
        <li>
          ...
          <p class="tip">
            同比增长<span v-if="overviewData.newUsersGrowth">
              <span class="red" :class="overviewData.newUsersGrowth > 0 ? '' : 'green'">{{
                overviewData.newUsersGrowth > 0
                  ? '+' + overviewData.newUsersGrowth
                  : overviewData.newUsersGrowth
              }}%</span>
